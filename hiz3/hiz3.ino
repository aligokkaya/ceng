...
void timerIsr()
{
 ...
 //Serial3.print("Motor hızı: "); 
 int devir = (sayac / 1); // buradaki 15 sayısı encoderdeki boşluk veya delik sayısıdır. Sizdeki kaç delik ise o sayıyı yazın.

 Serial.println(devir,DEC); 
 Serial3.println(devir,DEC); 
